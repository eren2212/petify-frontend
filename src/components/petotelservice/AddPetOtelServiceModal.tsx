...
import { useAddPetOtelService, usePetOtelServiceCategories } from "../../hooks";

interface AddPetOtelServiceModalProps {
  visible: boolean;
  onClose: () => void;
}
...
export default function AddPetOtelServiceModal({
  visible,
  onClose,
}: AddPetOtelServiceModalProps) {
  const { mutate: addService, isPending: isAdding } = useAddPetOtelService();
                  ...
                  <View className="flex-row items-start">
                    ...
                    <View className="flex-1">
                      ...
                      <Text className="text-xs text-blue-600">
                        Pet Hotel hizmetleri için sadece kategori seçimi
