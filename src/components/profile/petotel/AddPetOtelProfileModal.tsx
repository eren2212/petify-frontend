...
interface AddPetOtelProfileModalProps {
  visible: boolean;
  onClose: () => void;
  onSubmit: (profileData: PetOtelProfileData, logoUri: string | null) => void;
  isLoading?: boolean;
}

export interface PetOtelProfileData {
  hotel_name: string;
  description: string;
  address: string;
  latitude: number;
...
export default function AddPetShopProfileModal({
  ...
  const validateForm = (): boolean => {
    if (!hotelName.trim()) {
      Alert.alert("Hata", "Pet otel adı zorunludur");
      return false;
    }
  ...
  const handleSubmit = () => {
    ...
    const profileData: PetOtelProfileData = {
            ...
            <View className="bg-white rounded-t-3xl h-5/6">
              ...
              >
                ...
                <View className="mb-4">
                  ...
                  <TextInput
                    ...
                    placeholder="Pet otel adını girin"
                ...
                <View className="mb-4">
                  ...
                  <TextInput
                    ...
                    placeholder="Pet oteliniz hakkında kısa bir açıklama"
                    placeholderTextColor="#9CA3AF"
                    multiline
                    numberOfLines={4}
                ...
                {/* Kapasite */}
                <View className="mb-4">
                  <Text className="text-sm text-gray-600 mb-2">Kapasite *</Text>
                  <TextInput
              ...
              <View className="px-6 py-4 border-t border-gray-200">
                <TouchableOpacity
                  ...
                  disabled={isLoading || !hotelName.trim() || !address.trim()}
                  className={`py-4 rounded-full ${
                    isLoading || !hotelName.trim() || !address.trim()
                      ? "bg-gray-300"
                      : "bg-primary"
                  }`}
                >
