...
import { useUploadPetSitterLogo } from "../../../hooks/useProfile";

interface PetSitterLogoPickerProps {
  currentLogoUrl?: string | null;
  className?: string;
}

export default function PetShopLogoPicker({
  currentLogoUrl,
  className = "w-36 h-36",
}: PetSitterLogoPickerProps) {
  ...
  const getLogoUrl = () => {
    ...
    return `${process.env.EXPO_PUBLIC_API_URL}/petsitter/profile/image/${currentLogoUrl}`;
  };
