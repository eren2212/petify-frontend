...
import AddPetClinicServiceModal from "./AddPetClinicServiceModal";
import { COLORS } from "../../styles/theme/color";
import {
  useMyPetClinicServices,
  useDeletePetClinicService,
  usePetClinicServiceCategories,
  useUpdatePetClinicServiceStatus,
} from "../../hooks";
...
export default function PetClinicServiceList() {
  ...
  // Fetch data
  const { data, isLoading, refetch, isRefetching } = useMyPetClinicServices();
  const { data: categories = [] } = usePetClinicServiceCategories();
  ...
  const handleDeleteService = (service: Service) => {
    Alert.alert(
      "Hizmeti Sil",
      `"${service.clinic_service_categories.name_tr}" hizmetini silmek istediğinizden emin misiniz?`,
      [
        {
          text: "İptal",
          style: "cancel",
