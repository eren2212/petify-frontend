...
import {
  useAddPetSitterService,
  usePetSitterServiceCategories,
  usePetTypes,
} from "../../hooks";
import { PetType } from "../../types/type";

interface AddPetSitterServiceModalProps {
  visible: boolean;
  onClose: () => void;
}
...
export default function AddPetSitterServiceModal({
  visible,
  onClose,
}: AddPetSitterServiceModalProps) {
  const { mutate: addService, isPending: isAdding } = useAddPetSitterService();
